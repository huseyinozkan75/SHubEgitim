...
namespace NetFrameWorkMVCEgitimi.Controllers
{
    public class MVC04ModelBindingController : Controller
    {
        ...
        public ActionResult KullaniciDetay()
        {
            ...
            {
                Ad="Murat", Soyad="Yilmaz", Email="murat@yilmaz.com", KullaniciAdi="muraty", Sifre="123"

            };
            return View(kullanici); // kullanici nesnesini bu şekilde sayfaya
                                    // model verisi olarak gönderiyoruz yoksa hata veriyor.
        }

        [HttpPost]
        public ActionResult KullaniciDetay(Kullanici kullanici)
        {
            // burada gelen kullanıcı nesnesini db ye kaydedebiliriz.
        ...
        public ActionResult AdresDetay()
        {
            ...
            var model = new Adres()
            {
                Ilce = "Kartal",
                Sehir = "İstanbul",
                AcikAdres = "Gül Sok. Mercan Apt. No:18 Atalar"
            };
