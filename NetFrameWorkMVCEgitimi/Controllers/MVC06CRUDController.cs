...
namespace NetFrameWorkMVCEgitimi.Controllers
{
    public class MVC06CRUDController : Controller
    {
        ...
        public ActionResult Edit(Uye uye)
        {
            if (ModelState.IsValid)
            {
                db.Entry(uye).State = System.Data.Entity.EntityState.Modified; // ekrandan gelen üye nesnesinin ef deki kayıty durumunu güncellenecek olarak işaretle
                db.SaveChanges();
                return RedirectToAction("Index");
            }
        ...
        public ActionResult Delete(int id, Uye uye)
        {
            ...
            db.Entry(uye).State = System.Data.Entity.EntityState.Deleted; // ekrandan gelen üye nesnesinin ef deki kayıty durumunu silinecek olarak işaretle
