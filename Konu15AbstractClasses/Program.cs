namespace Konu15AbstractClasses
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Database database = new Database(); // Abstract class'lardan nesne oluşturulamaz.
    ...
    {
        public void Add() {
            Console.WriteLine( "Add metodu çalıştı");
        }
    ...
    class SqlServer : Database
    {
        public  void Add()
        {
            Console.WriteLine("SqlServer Add metodu çalıştı. Ekleme yapıldı.");
        }
    ...
    class Oracle : Database
    {
        public  void Add()
        {
            Console.WriteLine("Oracle Add metodu çalıştı. Ekleme yapıldı.");
        }
        public override void Delete()
        {
    ...
    class MySql : Database
    {
        public  void Add()
        {
            Console.WriteLine("MySql Add metodu çalıştı. Ekleme yapıldı.");
        }
        public override void Delete()
        {
